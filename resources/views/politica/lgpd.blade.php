            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4 p-md-5">
                    ...
                    <div class="text-justify">
                        ...
                        <p>Na presente empreitada, a SOMAXI GROUP designou a <strong>Sra. Denise Juliatto</strong> e o
                            <strong>Sr. Urik Pokrovsky</strong>, profissionais Certificados em Proteção e Privacidade de
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <a href="{{ asset('pdfs/Politicas/politica_de_privacidade.pdf') }}" class="fapeu-button" target="_blank">
