...
<div class="container text-justify">
    ...
    <div class="row my-4">
        <div class="col-md-4 col-sm-12"><img src="images/sustentavelecobag.png" alt="Ecobag" width="330" height="330" class="shadow-lg"></div>
    ...
    <hr>
    <div class="row my-4">
        <div class="col-md-4 col-sm-12"><img src="images/sustentavelcaneca.png" alt="Ecobag" width="330" height="330" class="shadow-lg"></div>
        <div class="col-md-8 col-sm-12 margemtelapequena">
    ...
    <hr>
    <div class="row my-4">
        <div class="col-md-4 col-sm-12"><img src="images/sustentavelenergia.png" alt="Ecobag" width="330" height="330" class="shadow-lg"></div>
        <div class="col-md-8 col-sm-12 margemtelapequena">
    ...
    <hr>
    <div class="row my-4">
        <div class="col-md-4 col-sm-12"><img src="images/sustentavelvidro.png" alt="Ecobag" width="330" height="330" class="shadow-lg"></div>
        <div class="col-md-8 col-sm-12 margemtelapequena">
    ...
    <hr>
    <div class="row my-4">
        <div class="col-md-4 col-sm-12"><img src="images/sustentavelcopo.png" alt="Ecobag" width="330" height="330" class="shadow-lg"></div>
        <div class="col-md-8 col-sm-12 margemtelapequena">
    ...
    <hr>
    <div class="row my-4">
        <div class="col-md-4 col-sm-12"><img src="images/sustentavelpilha.png" alt="Ecobag" width="330" height="330" class="shadow-lg"></div>
        <div class="col-md-8 col-sm-12 margemtelapequena">
