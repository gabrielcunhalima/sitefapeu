...
<div class="jumbotron jumbotron-fluid">
    <div class="container">
        <h1 class="font-weight-bold text-preto">Boas Práticas</h1>
    </div>
</div>
...
<div class="container text-justify">
    ...
    <p><b>Outras ações de sustentabilidade desenvolvidas pela FAPEU</b></p><br>

    <div class="row my-4">
        <div class="col-4"><img src="images/sustentavelecobag.png" alt="Ecobag" width="330" height="330" class="shadow-lg"></div>
        <div class="col-8">
            <p><b>Ecobag FAPEU</b></p>
            ...
            <p>A ideia foi chamar a atenção para os danos ambientais que o uso excessivo de sacolas plásticas tem causado ao planeta e ao cotidiano das pessoas, promovendo o consumo consciente de sacolas plásticas, transporte de compras e acondicionamento de lixo.</p>
            <p>Saiba mais sobre a importância da sacola reciclável <a href="https://indd.adobe.com/view/edbdff65-12b3-4735-b5c7-77fea43d4963">clicando aqui</a>.</p>
        </div>
    </div>
    <hr>
    <div class="row my-4">
        <div class="col-4"><img src="images/sustentavelcaneca.png" alt="Ecobag" width="330" height="330" class="shadow-lg"></div>
        <div class="col-8">
            <p><b>Canecas FAPEU</b></p>
    ...
    <hr>
    <div class="row my-4">
        <div class="col-4"><img src="images/sustentavelenergia.png" alt="Ecobag" width="330" height="330" class="shadow-lg"></div>
        <div class="col-8">
    ...
    <hr>
    <div class="row my-4">
        <div class="col-4"><img src="images/sustentavelvidro.png" alt="Ecobag" width="330" height="330" class="shadow-lg"></div>
        <div class="col-8">
            <p><b>Ponto de Entrega Voluntária de Vidros - PEV</b></p>
            ...
            <p>No ponto é possível descartar, segurança e praticidade, garrafas de bebidas, potes de alimentos, frascos de cosméticos ou medicamentos, copos e taças de vidros.</p>
            <p>O vidro é um material 100% reciclável e a separação na origem facilita a coleta pública, evitando danos ao equipamento e acidentes com garis.</p>
        </div>
    </div>
    <hr>
    <div class="row my-4">
        <div class="col-4"><img src="images/sustentavelcopo.png" alt="Ecobag" width="330" height="330" class="shadow-lg"></div>
        <div class="col-8">
            <p><b>Eco copo FAPEU</b></p>
            ...
            <p>O copo eco já está fazendo a diferença no nosso dia a dia.</p>
        </div>
    </div>
    <hr>
    <div class="row my-4">
        <div class="col-4"><img src="images/sustentavelpilha.png" alt="Ecobag" width="330" height="330" class="shadow-lg"></div>
        <div class="col-8">
            <p><b>Coletor de pilhas FAPEU</b></p>
    ...
    <hr>
    <div class="row my-4">
        <div class="col-4"><img src="images/sustentavellivro.png" alt="Ecobag" width="330" height="330" class="shadow-lg"></div>
        <div class="col-8">
