...
@section('conteudo')
    <div class="container pb-5">
        <div class="row g-4 mb-5">
            <div class="col-md-6">
                <div
                    class="card shadow-sm text-center border-0 hover-card position-relative overflow-hidden verdeclarofapeu">
                    <div class="card-body p-4">
                        <div class="">
                            <i class="bi bi-laptop text-verde3" style="font-size: 2.5rem;"></i>
                        </div>
                        <h3 class="card-title mb-3">Portal do Coordenador</h3>
                        <p class="card-text">Realize pedidos e liberações, consulte relatórios financeiros e tenha uma visão
                            completa do seu projeto.</p>
                        <a href="http://150.162.78.4:8080/manager/login/coordenador/" target="_blank"
            ...
            <div class="col-md-6">
                <div class="card shadow-sm border-0 hover-card position-relative overflow-hidden verdeclarofapeu">
                    <div class="card-body p-4">
                        ...
                        <p class="card-text text-center">Gerencie sua equipe, bolsistas e colaboradores com acesso direto ao
                            sistema de Recursos Humanos.</p>
                        <div class="text-center">
                            <a href="http://drhflow.fapeu.com.br:8080/DRHFlow/" target="_blank" class="btn btn-success">
            ...
            <div class="col-12">
                <div class="card shadow-sm border-0 hover-card position-relative overflow-hidden verdeclarofapeu">
                    <div class="card-body text-center">
                        ...
                        <h4 class="card-title">Cálculo de Encargos</h4>
        ...
        <div class="row mt-5">
            <div class="col-12">
                ...
                <p class="lead text-muted mb-4">Acesse todos os formulários necessários para a gestão do seu projeto
                    organizados por categoria.</p>
                ...
                <ul class="nav nav-tabs mb-4" id="formsTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="rh-tab" data-bs-toggle="tab" data-bs-target="#rh" type="button"
                            role="tab" aria-controls="rh" aria-selected="true">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="financeiro-tab" data-bs-toggle="tab" data-bs-target="#financeiro"
                            type="button" role="tab" aria-controls="financeiro" aria-selected="false">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="materiais-tab" data-bs-toggle="tab" data-bs-target="#materiais"
                            type="button" role="tab" aria-controls="materiais" aria-selected="false">
                            <i class="bi bi-box-seam me-1"></i>Materiais | Compras
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="importacao-tab" data-bs-toggle="tab" data-bs-target="#importacao"
                            type="button" role="tab" aria-controls="importacao" aria-selected="false">
                            ...
                            <table class="table table-hover shadow-sm border">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/1.3_formulario_dados_empregado_20_04_2018.doc"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/1.5_processo_seletivo.doc"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/1.10_alteracao_contrato_trabalho.doc"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/1.14 TCEPAE- Pós GraduaçãoGraduação UFSC.docx"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/1.16_atestado_de_f_rias-rescis_o_estagio.doc"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/1.18_modelo_termo_aditivo_TCE.doc"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/1.20_RH_termo_rescisao_estagio_pos.docx"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">16/08/2013</td>
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/1.30_formulario_alteracao_aux_alimentacao.doc"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/1.31_aditivo_ao_contrato_de_prestacao_servicos.docx"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">10/07/2014</td>
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/1.32_rescisao_de_contrato_de_prestacao_servicos.docx"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                            ...
                            <table class="table table-hover shadow-sm border">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/2.2_pagamento_juridico.doc"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/2.3_Regras_Reembolso.pdf"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/2.5_relatorio_viagem_fapesc.doc"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/2.6_solicitacao_de_fatura.doc"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/2.7_pagamento_juridico_fapeu.docx"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                            ...
                            <table class="table table-hover shadow-sm border">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/3.1_cadastro_fapeu_2015.docx"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                            ...
                            <table class="table table-hover shadow-sm border">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/4.1_c10_importacao_bens_servicos.doc"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">30/08/2016</td>
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/4.2.1_proforma_invoice_servicos.docx"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">30/08/2016</td>
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/4.2.2_proforma_invoice_softwares.docx"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">30/08/2016</td>
                                        <td class="text-center">
                                            <a href="pdfs/Projetos/4.2.3proforma_invoice_materiais.docx"
                                                class="btn btn-sm btn-outline-success rounded-pill">
                                                <i class="bi bi-download"></i> Download
                                            </a>
                                        </td>
                            ...
                            <div class="col-lg-8 mx-auto text-center">
                                <div class="card shadow-sm border-0">
                                    <div class="card-body p-4">
                                        ...
                                        <p class="text-muted mb-4">Documento orientativo com as normas e procedimentos para
                                            aquisições e contratações de serviços nos projetos gerenciados pela FAPEU.</p>
                                        <a href="{{ asset('pdfs/Projetos/Manual_de_Compras_e_Contratacoes.pdf') }}"
                                ...
                                <div class="pdf-viewer mt-4">
                                    <object class="pdf w-100 shadow-lg"
                                        data="{{url('pdfs/Projetos/Manual_de_Compras_e_Contratacoes.pdf')}}"
                                        style="height: 600px;">
                                        <p>Seu navegador não suporta a visualização de PDF. Por favor, <a
                                                href="{{ asset('pdfs/Projetos/Manual_de_Compras_e_Contratacoes.pdf') }}">clique
                                                aqui para baixar o arquivo</a>.</p>
                                    </object>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-4 fapeu-card">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-7 mb-3 mb-md-0">
                                ...
                                <p class="mb-0">Nossa equipe está pronta para auxiliá-lo. Entre em contato para tirar
                                    dúvidas sobre procedimentos, formulários ou sistemas.</p>
                            </div>
