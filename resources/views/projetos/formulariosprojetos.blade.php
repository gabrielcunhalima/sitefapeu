...
<div class="container" style="font-size:16px;">
    ...
    <table class="table table-bordered shadow">
        ...
        <tbody>
            ...
            <tr onclick="window.location.href='public/pdfs/Projetos/2.3_Regras_Reembolso.pdf'" style="cursor: pointer;">
            ...
            <tr onclick="window.location.href='public/pdfs/Projetos/2.6_solicitacao_de_fatura.doc'" style="cursor: pointer;">
