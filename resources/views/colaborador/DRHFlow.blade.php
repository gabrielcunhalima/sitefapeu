        ...
        <div class="row justify-content-center">
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.2s">
                <div class="card text-center shadow-lg border-0" style="width: 18rem; transition: transform 0.3s;">
                    ...
                    <div class="bg-dark p-3 rounded-top d-flex justify-content-center" style="margin-top: -20px;">
                        <img src="/path/to/your/money-icon.png" alt="Ícone de dinheiro" style="width: 40px; height: 40px;">
                    </div>
                    <div class="card-body">
