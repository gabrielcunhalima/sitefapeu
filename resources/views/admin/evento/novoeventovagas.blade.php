...
<div>
  <h5 class='center'>Cadastrando novo evento - Vagas [ID: {{$idNovoEvento}}]</h5>
  ...
  <table>
    ...
    <tr>
      ...
      {{-- <td><a href='{{url('/eventos/eventovagasdeletar/'.$idNovoEvento.'/' . $item->id)}}'> <i class="material-icons small green-text">delete</i></td> --}}
    </tr>
    @endforeach
    </tbody>
  </table>
...
<div class='row'>
  ...
  <div class='col s6' style="display: flex; justify-content: flex-end">
      <a class="btn waves-effect waves-light btnlarge" href='{{url('/eventos/formeventolote/'. $idNovoEvento )}}'>Próxima Etapa
