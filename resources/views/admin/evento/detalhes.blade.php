...
@section('conteudo')
    <h5 class='center'>Informações do Evento: <b>({{$evento->id}}) {{$evento->Titulo}}</b></h5>
        <div class='row green lighten-3' style="border-color: #FFF;border-radius: 12px;">
    ...
    <div class='row'>
        ...
        <div class='col s6' style="display: flex; justify-content: flex-end">
            <a href='{{route('admin.index')}}' class="waves-effect waves-light btn GREEN">CONFIRMAR EVENTO</a>
        </div>
    </div>
