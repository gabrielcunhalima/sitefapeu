    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            ...
            <div class="text-center mt-4">
                <a href="{{ route('noticias.noticiasrecentes') }}" class="btn btn-primary btn-lg px-4 py-2" style="border-radius: 50px; font-size: 1.1rem; text-transform: uppercase;">
                    Voltar para as noticias recentes.
                </a>
            </div>
        </div>
    </div>
