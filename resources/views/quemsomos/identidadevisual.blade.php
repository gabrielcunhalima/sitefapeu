        ...
        <div class="row clearfix">
            <div class="logo-pdf row mt-4">
                ...
                <div class="col-lg-3 col-md-4 col-sm-12">
                    <div class="card">
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/PDF/Logo_FAPEU_Cor.pdf') }}" download>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">Colorido</p>
                                    <small>Tamanho: 81 KB<span class="date text-muted">12 Fev 2025</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/PDF/Logo_FAPEU_Mono.pdf') }}" download>
                                <div class="file-name">
                                    ...
                                    <small>Tamanho: 77 KB <span class="date text-muted">12 Fev 2025</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/PDF/Logo_FAPEU_Negativo.pdf') }}" download>
                                <div class="file-name">
                                    ...
                                    <small>Tamanho: 73 KB <span class="date text-muted">12 Fev 2025</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/PDF/Logo_FAPEU_PB.pdf') }}" download>
                                <div class="file-name">
                                    ...
                                    <small>Tamanho: 76 KB <span class="date text-muted">12 Fev 2025</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/Corel/LogoFAPEU_Cor.cdr') }}" download>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">Colorido</p>
                                    <small>Tamanho: 15 KB <span class="date text-muted">12 Fev 2025</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/Corel/LogoFAPEU_Mono.cdr') }}" download>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">Monocromático</p>
                                    <small>Tamanho: 23 KB <span class="date text-muted">12 Fev 2025</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/Corel/LogoFAPEU_Negativo.cdr') }}" download>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">Negativo</p>
                                    <small>Tamanho: 24 KB <span class="date text-muted">12 Fev 2025</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/EPS/Logo_FAPEU_Cor.eps') }}" download>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">Colorido</p>
                                    <small>Tamanho: 461 KB <span class="date text-muted">Dec 12, 2016</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/EPS/Logo_FAPEU_Mono.eps') }}" download>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">Monocromático</p>
                                    <small>Tamanho: 452 KB <span class="date text-muted">12 Fev 2025</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/EPS/Logo_FAPEU_Negativo.eps') }}" download>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">Negativo</p>
                                    <small>Tamanho: 503 KB <span class="date text-muted">12 Fev 2025</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/EPS/Logo_FAPEU_PB.eps') }}" download>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">Preto e Branco</p>
                                    <small>Tamanho: 455 KB <span class="date text-muted">12 Fev 2025</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/Illustrator/Logo_FAPEU_Cor.ai') }}" download>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">Colorido</p>
                                    <small>Tamanho: 90 KB <span class="date text-muted">12 Fev 2025</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/Illustrator/Logo_FAPEU_Negativo.ai') }}" download>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">Negativo</p>
                                    <small>Tamanho: 69 KB <span class="date text-muted">12 Fev 2025</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="file bg-cinza2">
                            <a href="{{ asset('images/Logo/Illustrator/Logo_FAPEU_PB.ai') }}" download>
                                <div class="file-name">
                                    <p class="m-b-5 text-muted">Preto e Branco</p>
                                    <small>Tamanho: 72 KB <span class="date text-muted">12 Fev 2025</span></small>
                                </div>
                            </a>
                        </div>
                    </div>
