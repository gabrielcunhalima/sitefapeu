        ...
        <div class="row g-4 mb-4">
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex mb-3">
                    ...
                    <div>
                        <p class="mb-0 text-white-50">Rua Delfino Conti, s/n<br>Campus Universitário UFSC<br>Bairro Trindade - Florianópolis/SC<br>CEP 88040-370</p>
                    </div>
                </div>
                <div class="d-flex mb-3">
                    <div class="flex-shrink-0 me-3 text-white-50">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex mb-3">
                    ...
                    <div>
                        <p class="mb-0 text-white-50">Caixa Postal 5078<br>Bairro Trindade - Florianópolis/SC<br>CEP 88035-972</p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="list-unstyled footer-links">
                    <li class="mb-2">
                        <a href="{{ route('transparencia.projetostransparencia') }}" class="text-white-50 text-decoration-none">
                            <i class="bi bi-chevron-right small me-2"></i>Portal da Transparência
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('faleconosco.contato') }}" class="text-white-50 text-decoration-none">
                            <i class="bi bi-chevron-right small me-2"></i>Fale Conosco
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="{{ route('projetos.menuprojetos') }}" class="text-white-50 text-decoration-none">
                            <i class="bi bi-chevron-right small me-2"></i>Gestão de Projetos
                        </a>
                    </li>
                    <li class="mb-2">
            ...
            <div class="col-lg-3 col-md-6 text-center text-md-start">
                ...
                <div class="social-icons d-flex gap-3 justify-content-center justify-content-md-start">
                    ...
                    <a href="https://www.facebook.com/fapeu/?locale=pt_BR" class="text-white social-icon" target="_blank">
            ...
            <div class="row align-items-center">
                <div class="text-center">
                    <p class="mb-0 text-white-50 small">
                        &copy; {{ date('Y') }} Fundação de Amparo à Pesquisa e Extensão Universitária. Todos os direitos reservados.
                    </p>
                    <p class="mb-0 text-white-50 small">
