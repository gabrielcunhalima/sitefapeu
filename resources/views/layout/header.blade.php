...
<body>
    <header>
      <div>
        <span><i class="bi bi-telephone"></i> +55 48 3331-7400</span>
        <i class="bi bi-envelope"></i>
        <span>contato@fapeu.org.br</span>
        <a href="https://instagram.com/@fapeu_" class="sociais"><i class="bi bi-instagram"></i></a>
        <a href="" class="sociais"><i class="bi bi-facebook"></i></a>
        <a href="" class="sociais"><i class="bi bi-linkedin"></i></a>
      </div>
    </header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-between">
        <div class="container pesquisa">
          <img src="C:\wamp64\www\sitefapeu\public\images\logo2.png" alt="logofapeu" class="logo">
