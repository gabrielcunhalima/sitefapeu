...
<div class="page-container">
    <h3 class='center'>Pagamento por CARTÃO DE CRÉDITO</h3>
    <div class="row"> 
    ...
    @endphp
    <center>
        <a class="btn waves-effect waves-light btnlarge pay-button-getnet">FINALIZAR PAGAMENTO</a>

            <script async src="https://checkout.getnet.com.br/loader.js"
                            data-getnet-sellerid="{{$dados['seller_id']}}"
                            data-getnet-payment-methods-disabled = '["boleto","debito","pix","qr-code"]'
