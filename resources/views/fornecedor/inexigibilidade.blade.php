            ...
            <div class="alert alert-primary border-0 shadow-sm" role="alert">
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <p class="mb-1">A inexigibilidade de licitação ocorre quando há impossibilidade jurídica de competição, conforme Art. 25 da Lei nº 8.666/93.</p>
                        <p class="mb-0">Principais casos: fornecedor exclusivo, serviços técnicos especializados de natureza singular, contratação de profissional de notória especialização.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-header bg-principal text-white border-0">
                    <div class="d-flex justify-content-between align-items-center">
                        <span class="badge bg-light text-dark">
                            <span id="totalRegistros">{{ $licitacoes->where('tipo_licitacao', 3)->count() }}</span> registros
                        </span>
                    </div>
                </div>
                                ...
                                <thead class="bg-light">
                                    <tr>
                                        <th class="px-4 py-3 text-center" style="width: 80px;">
                                            <i class="bi bi-hash text-muted"></i> Inexigibilidade
                                        </th>
                                        <th class="px-4 py-3">
...
function limparFiltros() {
    ...
    document.getElementById('totalRegistros').textContent = {{ $licitacoes->where('tipo_licitacao', 3)->count() }};
}
