...
<div class="container mt-5 pb-5">
    <form action="{{ route('calculorpa.processar') }}" method="POST" class="bg-green-light p-4 rounded shadow">
        @csrf
        <div class="mb-3">
            <label for="valor_bruto" class="form-label">Valor Bruto:</label>
            <input type="number" step="0.01" name="valor_bruto" id="valor_bruto" class="form-control" required>
        </div>
