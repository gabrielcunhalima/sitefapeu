...
CREATE TABLE `eventos` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `NumConta` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT '203142-6',
  `IDRubrica` int DEFAULT '15',
  `IDSubRubrica` int DEFAULT '15',
  ...
  `TotalVagasGeral` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=82 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `inscricao` (
  ...
  `qtdParcelas` varchar(100) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `authorization_timestamp` varchar(100) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `inscricao_id_evento_foreign` (`id_evento`),
  KEY `inscricao_id_modalidade_foreign` (`id_modalidade`)
) ENGINE=MyISAM AUTO_INCREMENT=119 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `inscricao_deletadas`
--

DROP TABLE IF EXISTS `inscricao_deletadas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `inscricao_deletadas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `_token` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `id_evento` int unsigned NOT NULL,
  `id_modalidade` int unsigned NOT NULL,
  ...
  `Cupom` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `valorPago` double DEFAULT NULL,
  `deletadoPor` varchar(100) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `deletadoEm` varchar(100) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `inscricao_id_evento_foreign` (`id_evento`) USING BTREE,
  KEY `inscricao_id_modalidade_foreign` (`id_modalidade`) USING BTREE
...
-- Dump completed on 2024-06-14  9:59:17
