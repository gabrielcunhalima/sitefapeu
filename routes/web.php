...
Route::any('/noticiaspost', [MenuController::class, 'noticiaspost'])->name('noticias.noticiaspost');
...
Route::get('/admin/menu', [MenuController::class, 'paineladministrativo'])->name('admin.menu');
Route::match(['get', 'post'], '/admin/createadmin', [AuthController::class, 'createAdmin'])->name('admin.createadmin');
Route::get('/editar', [MenuController::class, 'editarNoticias'])->name('noticias.editarnoticias');
Route::match(['get', 'post'], '/adicionarlicitacao', [MenuController::class, 'adicionarlicitacao'])->name('fornecedor.adicionarlicitacao');
